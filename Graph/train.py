...
def main(args: argparse.Namespace):
    wandb.login()
    wandb.init(project="dkt", entity="new-recs", config=vars(args))
    wandb.run.name = 'gcn_'+ args.item
    set_seeds(args.seed)
    ...
    train_data, test_data, n_node = prepare_dataset(device=device, data_dir=args.data_dir, item=args.item)
