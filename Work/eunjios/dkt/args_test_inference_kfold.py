...
# TODO: args_test_inference_kfold.py 와 합치기 
def main(args: argparse.Namespace):
    ...
    # best fold 직접 지정
    # TODO: args로 best fold 지정 
    model: torch.nn.Module = args_test_trainer_kfold.load_model_kfold(args=args, fold=3).to(args.device)
    
    # best fold 직접 지정
    # TODO: args로 best fold 지정 
    logger.info("Make Predictions & Save Submission ...")
    args_test_trainer_kfold.inference_kfold(args=args, test_data=test_data, model=model, fold=3)
